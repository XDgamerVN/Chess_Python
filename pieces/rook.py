...
def check_rook(position, color):
    """
    Kiểm tra các nước đi hợp lệ của quân Xe dựa trên vị trí hiện tại và màu sắc.

    Args:
        position (tuple): Tọa độ hiện tại của quân Xe (x, y).
        color (str): Màu sắc của quân Xe ('white' hoặc 'black').

    Returns:
        list: Danh sách các nước đi hợp lệ cho quân Xe.
    """
    moves_list = []
    ...
    # Các hướng đi của quân Xe: xuống, lên, phải, trái
